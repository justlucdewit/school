...
CREATE TABLE IF NOT EXISTS `klanten` (
  ...
  `Paswoord` char(128) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `klanten` (`KlantID`, `Voornaam`, `Achternaam`, `Adres`, `Postcode`, `Plaats`, `TelefoonNr`, `Email`, `Inlognaam`, `Paswoord`, `Salt`, `Level`) VALUES
